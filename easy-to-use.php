...
if( ! function_exists( 'easy_to_use_unqprfx_login_enqueue_scripts' ) ) :
	function easy_to_use_unqprfx_login_enqueue_scripts() { // add styles and scripts to login page
	...
	add_action( 'login_enqueue_scripts', 'easy_to_use_unqprfx_login_enqueue_scripts' );
endif;


if( ! function_exists( 'easy_to_use_unqprfx_admin_enqueue_scripts' ) ) :
	function easy_to_use_unqprfx_admin_enqueue_scripts() {  // add styles and scripts to admin section
		// wp_enqueue_script('jquery');
		wp_enqueue_script( 'easy-to-use-script', plugins_url( '/js/easy-to-use.js', __FILE__ ), array('jquery') );
		wp_enqueue_style( 'easy-to-use-style', plugins_url( '/css/easy-to-use.css', __FILE__ ) );
	}
	add_action('admin_enqueue_scripts', 'easy_to_use_unqprfx_admin_enqueue_scripts');
endif;
